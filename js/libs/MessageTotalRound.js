function MessageTotalRound(posX, posY, posZ, textureLoader, stringPattern, col, row, stringIn,  alignment, widthCharacter, heightCharacter,  distanceBetweenCharacters) {
...
MessageTotalRound.prototype.setString = function(stringIn) {
